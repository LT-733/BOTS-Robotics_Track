...
def arms_up(hug_left, hug_right, r_left, r_right, w_left, w_right):
    ...
    ARMS_UP_EXPECTED_TIME = 8.0        # seconds, bottom to top under normal conditions
    ...
    HAND_STUCK_THRESH = 2
    HAND_TIGHTEN_STEP = 0.005
    HAND_LOOSEN_STEP = 0.03
    HAND_LOOSEN_COOLDOWN = 0.2
    ...
    def _move_arm_and_hand(reader, writer, hug, sign):
        ...
        last_loosen = -HAND_LOOSEN_COOLDOWN
        arm_done = False
        ...
        while True:
            ...
            if scaled_torque > HAND_STUCK_THRESH:
                if now_t - last_loosen >= HAND_LOOSEN_COOLDOWN:
                    hand_pos -= HAND_LOOSEN_STEP * sign
                    last_loosen = now_t
